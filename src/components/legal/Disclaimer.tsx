      ...
      <div className="relative">
        <div className="container max-w-6xl mx-auto px-4 py-12">
          ...
          <div className="text-gray-400 text-lg leading-8 px-4 py-4">
            ...
            <p className="mb-4">
              In no event shall <b className="text-white">CYPHERSOL</b> be held
            ...
            <div className="pl-10 mb-4">
              <li>
                ...
                for any particular purpose of the contents of this Website;
              </li>
              <li>
            ...
            <p className="mb-4">
              ...
              and usefulness of our Services and other information provided by
              us on the platforms owned or operated by{" "}
              <b className="text-white">CYPHERSOL</b> .
            </p>
            <p className="mb-4">
              Any content downloaded or otherwise obtained through the use of
              our website is done at your own discretion and risk, and We cannot
              confirm that such documents or contents are errors or viruses free
              and You understand and acknowledge that you are solely responsible
              for any damage to your devices, for any loss of data that may
              result from the download of such contents.
            </p>
            <p className="mb-4">
              <b className="text-white">CYPHERSOL</b> reserves the right to
              disable any unauthorized links or frames and disclaims any
              responsibility for the content available on any other site reached
              by links to or from this Website or any of the contents.
            </p>
            <p className="mb-4">
              Click here for the complete Website Terms and conditions Policy of{" "}
              <b className="text-white">CYPHERSOL</b>
            </p>
            <p className="mb-4">
              ...
              you have read, reviewed, understood, and agreed to be bound by all
              the terms and conditions and agree to comply with its terms.
            </p>
          </div>
        </div>
      </div>
