        ...
        <div className="container max-w-6xl mx-auto px-4 py-12">
          ...
          <div className="text-gray-400 text-lg leading-8 px-4 py-4">
            <p className="mb-4">
              ...
              subscription. In the case of a subscription, access will be active
              throughout the paid subscription period. Upon payment, an invoice
              will be promptly issued, granting the customer immediate service
              usage.
            </p>
            <p className="mb-4">
              The Customer must pay the Charges by debit card, credit card,
              direct debit, bank transfer, UPI, or by using such payment details
              as are notified by the Provider to the Customer from time to time.
              The payments shall be made in the official bank account of the
              Provider only.
            </p>
            ...
            <p className="mb-4">
              ...
              of its SaaS services. In the event of such refusal, whether for a
              new or renewing subscription/membership, customers will be
              eligible for a prorated refund corresponding to the remaining days
              in the purchased subscription plan or the unused portion of the
              pre-established service limits.
            </p>
            <p className="mb-4">
