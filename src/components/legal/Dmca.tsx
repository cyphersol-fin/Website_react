          ...
          <div className="container mx-auto max-w-6xl max-auto px-4 py-12">
            ...
            <div className="text-gray-400 text-lg leading-8 px-4 py-4">
              <p className="mb-4">
                ...
                and is committed to complying with and upholding the provisions
                of the Digital Millennium Copyright Act ("DMCA"). This policy
              ...
              <p className="mb-4">
                ...
                upon on any of the Company's platforms, websites, or services,
                you may submit a notification ("DMCA Notice") to our Designated
                Agent/ Legal Representative. The DMCA Notice should include the
              ...
              <div className="pl-14 mb-4">
                ...
                <li>
                  ...
                  and the location where it appeared before its removal or
                  disablement.
                </li>
                <li>
                ...
                <li>
                  A statement that you consent to the jurisdiction of the court
                  in Rajasthan, India, and a statement that you will accept
              ...
              <p className="mb-4">
                If the DMCA Notice meets the requirements set forth above, we
                will promptly remove or disable access to the allegedly
                infringing material after doing our own due diligence.
              </p>
              <h3 className="text-2xl text-white font-semibold mb-4">
              ...
              <p className="mb-4">
                ...
                the user who posted the material of the takedown and provide
                them with a copy of the DMCA Notice. We will also inform the
                user about their right to submit a counter-notice.
              </p>
              <h3 className="text-2xl text-white font-semibold mb-4">
                REPEAT INFRINGERS
              </h3>
              <p className="mb-4">
                ...
                including removing content, disabling accounts, or pursuing
                legal remedies.
              </p>
              <h3 className="text-2xl text-white font-semibold mb-4">
              ...
              <p className="mb-4">
                ...
                resulting from the actions of its users or third parties.
                However, we are committed to promptly responding to and
                addressing valid DMCA Notices in accordance with this policy.
              </p>
              <h3 className="text-2xl text-white font-semibold mb-4">
              ...
              <p className="mb-4">
                ...
                required and may disclose relevant user information in
              ...
              <p className="mb-4">
                By using the Company's platforms, websites, or services, you
                agree to comply with this DMCA Policy.
              </p>
            </div>
          </div>
        </div>
