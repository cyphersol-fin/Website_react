...
export const Team = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Meet Our Experts in IT Solutions & Accounting Automation | Cyphersol
          Team
        </title>
        <meta
          name="description"
          content="Meet the dedicated team behind Cyphersol's innovative IT solutions and accounting automation tools. Our experts are committed to helping chartered accountants and MSMEs in India streamline workflows and boost efficiency."
        />
        <meta
          name="keywords"
          content="Cyphersol team, IT solutions experts, accounting automation specialists, chartered accountants, MSME solutions, software development team, innovative technology, accounting software"
        />
      </Helmet>
